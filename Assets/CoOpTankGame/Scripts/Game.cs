...
public class Game : MonoBehaviour 
{
	...
	public int maxScore = 3;							//The score that when a player reaches, will end the game.
	public int maxProjectileBounces = 0;				//The maximum amount of times a projectile can bounce off walls.
	...
	public float tankStartMoveSpeed = 170;				//The move speed the player tanks will get when the game starts.
	public float tankStartTurnSpeed = 150;				//The turn speed the player tanks will get when the game starts.
	public float tankStartProjectileSpeed = 600;			//The projectile speed the player tanks will get when the game starts.
	public float tankStartReloadSpeed = 2.1f;				//The reload speed the player tanks will get when the game starts.
    ...
    public static explicit operator Game(GameObject v)
    {
