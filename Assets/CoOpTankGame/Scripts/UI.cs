...
public class UI : MonoBehaviour 
{
	...
	{
        //p1HealthBar.maxValue = game.player1Tank._infmaxHealth;
        //p2HealthBar.maxValue = game.player2Tank._infmaxHealth;
        p1HealthBar.maxValue = game.tankStartHealth;
        p2HealthBar.maxValue = game.tankStartHealth;
    ...
    void Update ()
	{
		if(game.player1Tank != null){	//If player 1's tank exists.
			...
			p1HealthBar.value = game.player1Tank._infhealth;                                                    //Sets the value of the health bar to be the same as the tank's.
            game.player2Tank._infEnemyHealth = game.player1Tank._infhealth;
        }
		if(game.player2Tank != null){	//If player 2's tank exists.
			...
			p2HealthBar.value = game.player2Tank._infhealth;                                                    //Sets the value of the health bar to be the same as the tank's.
            game.player1Tank._infEnemyHealth = game.player2Tank._infhealth;
        }	
